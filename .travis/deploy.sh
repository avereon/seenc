...
chmod 600 $HOME/.ssh/*
scp -B target/product.jar travis@avereon.com:/opt/avn/store/stable/seenc/product.jar && echo "Deployed /opt/avn/store/stable/seenc/product.jar"
scp -B target/main/java/META-INF/product.card travis@avereon.com:/opt/avn/store/stable/seenc/product.card && echo "Deployed /opt/avn/store/stable/seenc/product.card"
