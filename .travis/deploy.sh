...
chmod 600 $HOME/.ssh/*
scp -B target/product.jar travis@avereon.com:/opt/avn/store/stable/seenc && echo "Deployed /opt/avn/store/latest/mouse/product.jar"
scp -B target/main/java/META-INF/product.card travis@avereon.com:/opt/avn/store/stable/seenc && echo "Deployed /opt/avn/store/latest/mouse/product.card"
